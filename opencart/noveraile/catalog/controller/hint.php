...
class Hint extends \Opencart\System\Engine\Controller {
    public function send(): void {
        ...
        if ((int)($this->session->data['noveraile_hint_time'] ?? 0) > time() - 60) $json['error'] = $this->language->get('six_error_rate_limit');
