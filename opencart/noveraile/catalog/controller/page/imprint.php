...
<dl class="legal-details">
  <div><dt>Trading name</dt><dd>NOVERAILE Jewelry</dd></div>
...
<p class="legal-note"><strong>Merchant notice:</strong> Entries highlighted as “to be completed” are mandatory launch information and must be replaced in the NOVERAILE module settings before accepting orders. Requirements vary by country; have this notice reviewed for the markets in which you sell.</p>
HTML;
    }
