...
class Privacy extends \Opencart\System\Engine\Controller {
    ...
    private function copy(): string {
        ...
        return <<<HTML
<p class="legal-intro">This privacy policy explains how 6MOMENTS collects and uses personal data when you browse the store, contact the atelier, create an account, subscribe to the newsletter or place an order.</p>
...
<ul>
  ...
  <li><strong>Payment data:</strong> payment status and transaction identifiers. Card details are entered directly on Stripe's secure checkout and are not stored by 6MOMENTS.</li>
