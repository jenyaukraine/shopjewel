<?php
namespace Opencart\Catalog\Model\Extension\Sixmoments\Total;
...
class Bundle extends \Opencart\System\Engine\Model {
    public function getTotal(array &$totals, array &$taxes, float &$total): void {
        ...
        if ($discount_total > 0) {
            $this->load->language('extension/sixmoments/total/bundle');
            $totals[] = ['extension'=>'sixmoments','code'=>'bundle','title'=>$this->language->get('text_bundle_discount'),'value'=>-$discount_total,'sort_order'=>(int)$this->config->get('total_bundle_sort_order')];
